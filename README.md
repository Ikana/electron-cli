...
```json
{
  ...
  "electronCli": {
    ...
    "makers": [
      ...
      { "name": "@electron-forge/maker-wix", "platforms": ["win32"], "config": { "manufacturer": "Example Inc", "exe": "my-app.exe", "language": 1033, "shortcutFolderName": "Example Inc", "installLevel": 2, "defaultInstallMode": "perUser", "associateExtensions": "thing,work", "features": { "autoLaunch": { "enabled": true, "arguments": ["--hidden"] } } } }
    ],
    "publishers": [
